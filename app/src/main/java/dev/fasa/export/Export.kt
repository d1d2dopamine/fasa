...
object Export {
    ...
    fun fileName(): String = "fasa-export-" + LocalDate.now() + ".json"
    ...
    suspend fun build(context: Context): String = withContext(Dispatchers.IO) {
        ...
        val root = JSONObject()
        root.put("format", "fasa-sleep-export")
    ...
    private fun source(): JSONObject {
        val o = JSONObject()
        o.put("application", "fasa")
        o.put("application_url", "https://github.com/d1d2dopamine/fasa")
        o.put("platform", "Android")
        o.put("wearable", "Xiaomi Smart Band 9 Active")
        o.put("wearable_vendor_app", "Mi Fitness")
        o.put("pipeline", "Xiaomi Smart Band 9 Active -> Mi Fitness -> Android Health Connect -> fasa local database")
    ...
    private fun notes(): JSONArray = JSONArray(
        listOf(
            "This file was produced by fasa, a personal circadian tracking app. It is raw observational data, not a medical record.",
    ...
    private suspend fun modelJson(context: Context): JSONObject {
        ...
        fun med(sel: (dev.fasa.model.Particle) -> Double): Double {
